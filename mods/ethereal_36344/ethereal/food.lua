...
local mod_fredo = core.get_modpath("farming")
...
core.register_node("ethereal:banana_bunch", {
...
core.register_craftitem("ethereal:pine_nuts", {
...
local fredo = core.get_modpath("farming") and farming and farming.mod
...
core.register_node("ethereal:coconut", {
...
core.register_craftitem("ethereal:coconut_slice", {
...
core.register_node("ethereal:lemon", {
	description = S("Lemon"),
	drawtype = "plantlike",
...
core.register_node("ethereal:olive", {
	description = S("Olive"),
	drawtype = "plantlike",
...
core.register_craftitem("ethereal:olive_oil", {
...
core.register_craftitem("ethereal:sushi_kappamaki", {
...
core.register_craftitem("ethereal:sushi_nigiri", {
...
core.register_craftitem("ethereal:sushi_tamago", {
...
core.register_craftitem("ethereal:fugu", {
...
core.register_craftitem("ethereal:teriyaki_chicken", {
...
core.register_craftitem("ethereal:teriyaki_beef", {
	description = S("Teriyaki Beef"),
	inventory_image = "ethereal_teriyaki_beef.png",
	on_use = core.item_eat(12, bowl)
})
...
core.register_craftitem("ethereal:mushroom_soup", {
...
core.register_craftitem("ethereal:fish_shrimp_cooked", {
...
core.register_craftitem("ethereal:garlic_shrimp", {
...
core.register_craftitem("ethereal:jellyfish_salad", {
...
core.register_craftitem("ethereal:calamari_raw", {
...
core.register_craftitem("ethereal:calamari_cooked", {
...
core.register_craftitem("ethereal:fish_n_chips", {
